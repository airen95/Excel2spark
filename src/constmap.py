...
assess_class = {'CASH, GOLD AND CASH EQUIVALENT' : ['CASH'],
...
total_cols2sum = ['ACCRUED_INTEREST_LCY',
 'EAD AFTER CRM (OFF-BS)',
 'EAD AFTER CRM (ON-BS)',
 'EAD BEFORE CRM (OFF-BS)',
 'EAD BEFORE CRM (ON-BS)',
 'FINAL_ADJUSTED_COLL',
 'FINAL_ADJUSTED_GUARANTEE',
 'NETTING_VALUE_ADJUSTED',
 'OUTSTANDING_AMT_LCY / UTILIZED LIMIT',
 'OUTSTANDING_FEES_PENALITIES_LCY',
 'RWA_OFF_BS',
 'RWA_OFF_BS Without CRM',
 'RWA_ON_BS',
 'RWA_ON_BS Without CRM']